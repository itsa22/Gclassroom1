...
<body>
    ...
    <a href="liste_cours_etu.php" class="btn btn-secondary btn-lg" role="button" aria-pressed="true" style="background-color:#545212;font-size:30px">Retour</a>
    ...
    <?php
        include("fonction.php");
        $recup=$conn->prepare("SELECT nom_etu, email, prenom_etu from etudiant WHERE id_etu='$id_etu'");
        $recup->execute();
        $data_recup=$recup->fetch();
        $nom_etu=$data_recup['nom_etu'];
        $prenom_etu=$data_recup['prenom_etu'];
